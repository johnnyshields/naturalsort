...
<head>
  <title>%title%</title>
  <meta name="description" content="NaturalSort is a small and simple library to implements a natural or human alphabetical sort in ruby."/>
  <meta name="keywords" content="ruby natural sort human alphabetical alpha alphanum library order"/>
